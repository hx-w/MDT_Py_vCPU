...
from correspondence import compute_correspondence, compute_adjacent_by_edges, TransformMatrix
...
if __name__ == "__main__":
    ...
    cfg = ConfigFile.load(ConfigFile.Paths.custom.face_human)
    ...
    mapping = compute_correspondence(original_source, original_target, corr_markers, plot=False)
